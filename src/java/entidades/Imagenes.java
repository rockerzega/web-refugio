...
@NamedQueries({
    ...
    , @NamedQuery(name = "Imagenes.findByRefugio", query = "SELECT i FROM Imagenes i WHERE i.refugio = :refugio")
...
public class Imagenes implements Serializable {
    ...
    public Imagenes(Integer id, String refugio) {
        this.id = id;
    ...
    public String toString() {
        return "entidades.Imagenes[ id=" + id + " ]";
    }
